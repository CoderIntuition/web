...
export const LeftColumn = cntl`relative w-full lg:w-5/12 text-center max-w-lg mt-0 mb-16 xs:mb-16 sm:mb-0 md:mt-32 lg:mt-16 mx-auto lg:max-w-none lg:text-left`;
