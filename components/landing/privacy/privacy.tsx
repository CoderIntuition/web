...
import { HeadingRow, Text, TextH1, TextH2, TextLi, TextP, TextUl } from "./privacy-styles";
        ...
        <div className={Container}>
          <div className={ContentWithPaddingXl}>
            ...
            <div className={Text}>
              ...
              <h1 className={TextH1}>Interpretation and Definitions</h1>
              <h2 className={TextH2}>Interpretation</h2>
              <p className={TextP}>
              ...
              <h2 className={TextH2}>Definitions</h2>
              <p className={TextP}>For the purposes of this Privacy Policy:</p>
              <ul className={TextUl}>
                <li className={TextLi}>
              ...
              <h1 className={TextH1}>Collecting and Using Your Personal Data</h1>
              <h2 className={TextH2}>Types of Data Collected</h2>
              ...
              <h3>Usage Data</h3>
              <p className={TextP}>Usage Data is collected automatically when using the Service.</p>
              <p className={TextP}>
              ...
              <p className={TextP}>We use both session and persistent Cookies for the purposes set out below:</p>
              <ul className={TextUl}>
                <li className={TextLi}>
                  <strong>Necessary / Essential Cookies</strong>
                  <p className={TextP}>Type: Session Cookies</p>
                  <p className={TextP}>Administered by: Us</p>
                  <p className={TextP}>
                ...
                <li className={TextLi}>
                  ...
                  <p className={TextP}>Type: Persistent Cookies</p>
                  <p className={TextP}>Administered by: Us</p>
                  <p className={TextP}>
              ...
              <h2 className={TextH2}>Use of Your Personal Data</h2>
              <p className={TextP}>The Company may use Personal Data for the following purposes:</p>
              <ul className={TextUl}>
                <li className={TextLi}>
              ...
              <p className={TextP}>We may share your personal information in the following situations:</p>
              ...
              <h2 className={TextH2}>Retention of Your Personal Data</h2>
              <p className={TextP}>
              ...
              <h2 className={TextH2}>Transfer of Your Personal Data</h2>
              <p className={TextP}>
              ...
              <h2 className={TextH2}>Disclosure of Your Personal Data</h2>
              ...
              <ul className={TextUl}>
                <li className={TextLi}>Comply with a legal obligation</li>
                <li className={TextLi}>Protect and defend the rights or property of the Company</li>
                <li className={TextLi}>Prevent or investigate possible wrongdoing in connection with the Service</li>
                <li className={TextLi}>Protect the personal safety of Users of the Service or the public</li>
                <li className={TextLi}>Protect against legal liability</li>
              </ul>

              <h2 className={TextH2}>Security of Your Personal Data</h2>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Children's Privacy</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Links to Other Websites</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Changes to this Privacy Policy</h1>
              <p className={TextP}>
