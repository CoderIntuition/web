...
import { Heading, HeadingRow, Text, TextH1, TextH2, TextLi, TextP, TextUl } from "./terms-styles";
        ...
        <div className={Container}>
          <div className={ContentWithPaddingXl}>
            ...
            <div className={Text}>
              ...
              <p className={TextP}>Please read these terms and conditions carefully before using Our Service.</p>
              ...
              <p className={TextP}>For the purposes of these Terms and Conditions:</p>
              <ul className={TextUl}>
                <li className={TextLi}>
              ...
              <h1 className={TextH1}>Acknowledgement</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Termination</h1>
              <p className={TextP}>
                We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
                whatsoever, including without limitation if You breach these Terms and Conditions.
              </p>
              <p className={TextP}>Upon termination, Your right to use the Service will cease immediately.</p>

              <h1 className={TextH1}>Limitation of Liability</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>"AS IS" and "AS AVAILABLE" Disclaimer</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Governing Law</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Disputes Resolution</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>For European Union (EU) Users</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>United States Legal Compliance</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Severability and Waiver</h1>
              <h2 className={TextH2}>Severability</h2>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Translation Interpretation</h1>
              <p className={TextP}>
                These Terms and Conditions may have been translated if We have made them available to You on our
                Service.
              </p>
              <p className={TextP}>You agree that the original English text shall prevail in the case of a dispute.</p>

              <h1 className={TextH1}>Changes to These Terms and Conditions</h1>
              <p className={TextP}>
              ...
              <h1 className={TextH1}>Contact Us</h1>
              <p className={TextP}>If you have any questions about these Terms and Conditions, You can contact us:</p>
